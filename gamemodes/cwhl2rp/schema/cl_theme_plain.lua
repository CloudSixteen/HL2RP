...
function THEME:Initialize()
	...
	Clockwork.option:SetFont("scoreboard_name", "hl2rp2_plain_TargetIDText");
	Clockwork.option:SetFont("scoreboard_desc", "hl2rp2_plain_MainText");
	Clockwork.option:SetFont("scoreboard_class", "hl2rp2_plain_IntroTextTiny");
